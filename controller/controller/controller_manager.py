...
L1_PARAMS = [
    ...
    'steering_filter_alpha', 'steering_rate_limit',
...
class ControllerManager(Node):
    ...
    def global_wpnts_cb(self, data: WpntArray):
        ...
        self.controller = Controller(
            ...
            self.steering_filter_alpha, self.steering_rate_limit,
    ...
    def create_ack_msg(self, speed, acceleration, jerk, steering_angle):
        ...
        ack_msg.drive.speed = float(min(speed,3.5))  # 초기값 ack_msg.drive.speed = float(speed)
