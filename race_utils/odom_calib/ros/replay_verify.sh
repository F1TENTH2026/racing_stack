...
# Env overrides:
#   UNICORN_SETUP   path to the ROS env setup to source (default: thirdimpact.sh in roboracer_ws)
...
UNICORN_SETUP="${UNICORN_SETUP:-/home/js/roboracer_ws/src/racing_stack/thirdimpact.sh}"
mkdir -p "$LOG"
rm -rf "$OUT"
